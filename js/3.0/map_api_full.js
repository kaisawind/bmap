...
(function () {
    ...
    z.fa.TX = /gecko/i.test(navigator.userAgent) && !/like gecko/i.test(navigator.userAgent);
    ...
    z.U.ja = function (a) {
        ...
        var b = z.U.TC(a)
            , c = z.fa
            , e = z.U.rg;
        c.TX > 0 && b.getBoxObjectFor && e(a, "position");
        var f = {
            left: 0,
            top: 0
        }, g;
        if (a == (c.ma && !c.HD ? b.body : b.documentElement))
            return f;
        ...
        ;
    /firefox\/(\d+\.\d)/i.test(navigator.userAgent) && (z.fa.Re = +RegExp.$1);
    /BIDUBrowser/i.test(navigator.userAgent) && (z.fa.A1 = p);
    ...
    z.aK = function () {
        function a(a) {
            document.addEventListener && (this.element = a,
                this.dK = this.sk ? "touchstart" : "mousedown",
                this.BC = this.sk ? "touchmove" : "mousemove",
                this.AC = this.sk ? "touchend" : "mouseup",
                this.hh = t,
                this.It = this.Ht = 0,
                this.element.addEventListener(this.dK, this, t),
        ...
        a.prototype = {
            ...
            move: function (a) {
                ...
                if (10 < Math.abs((this.sk ? a.touches[0].clientX : a.clientX) - this.Ht) || 10 < Math.abs(c - this.It))
                    this.hh = p
            },
            end: function (a) {
                oa(a);
                this.hh || (a = document.createEvent("Event"),
                    a.initEvent("tap", t, p),
    ...
    function Oa(a, b) {
        if (a = z.da(a)) {
            ...
            c.R = {
                ...
                yw: p,
                xw: 500,
                PV: b.enableHighResolution !== t,
                sC: b.enableMapClick !== t,
                devicePixelRatio: b.devicePixelRatio || window.devicePixelRatio || 1,
                hF: 99,
                xe: b.mapStyle || s,
                jY: b.logoControl === t ? t : p,
                eU: [],
                D1: b.beforeClickIcon || s,
                og: t,
                gk: t,
                po: t,
                bE: p,
            ...
            c.R.xe && (this.GX(c.R.xe.controls),
                this.kL(c.R.xe.geotableId));
            c.R.xe && c.R.xe.styleId && c.a3(c.R.xe.styleId);
            c.R.FB = {
                dark: {
                    backColor: "#2D2D2D",
                    textColor: "#bfbfbf",
            ...
            e === Va && Ta(Aa);
            e = c.R;
            e.ZN = Math.round(b.minZoom);
            e.YN = Math.round(b.maxZoom);
            c.vu();
            c.$ = {
                Ic: t,
                mc: 0,
    ...
    z.extend(Oa.prototype, {
        ...
        Xj: function (a, b, c, e) {
            var f = this.va().fc(this.ka())
                , g = this.Pc
                , i = p;
            c && J.oL(c) && (this.qe = new J(c.lng, c.lat),
                i = t);
            if (c = c && e ? g.ci(c, this.Wb) : this.gc)
                if (this.gc = new J(c.lng + a * f, c.lat - b * f),
                    (a = g.gh(this.gc, this.Wb)) && i)
                    this.qe = a
        },
        Cg: function (a, b) {
            if (Za(a) && (this.vu(),
                ...
                c && (c = this.Sb(c, this.Bc),
                    this.Xj(this.width / 2 - c.x, this.height / 2 - c.y, this.Ib(c, this.Bc), p));
        ...
        ki: function (a) {
            a instanceof J && (this.gc = this.Pc.ci(a, this.Wb),
                this.qe = J.oL(a) ? new J(a.lng, a.lat) : this.Pc.gh(this.gc, this.Wb))
        },
        xg: function (a, b) {
            a = Math.round(a) || 0;
            b = Math.round(b) || 0;
        ...
        qf: function (a) {
            ...
            if (a instanceof J)
                ...
                if (b.xb === Sa) {
                    ...
                    var e = this.WG();
                    e.xt(function (c) {
                        0 === e.fm() && 2 === e.Ma.result.type && (b.qf(c.ok(0).point),
                            Sa.kk(a) && b.AE(a))
                    });
                    e.search(a, {
                        log: "center"
        ...
        Ed: function (a, b) {
            ...
            if (bb(a))
                ...
                c.gc = c.Pc.ci(c.qe, c.Wb);
                c.QB = c.QB || c.Va;
                c.PB = c.PB || c.qe;
                var g = new Q("onload")
                    , i = new Q("onloadcode");
                g.point = new J(a.lng, a.lat);
                g.pixel = c.Sb(c.qe, c.Va);
                g.zoom = b;
                c.loaded || (c.loaded = p,
                    c.dispatchEvent(g),
                    ua || (ua = eb()));
        ...
        Be: function (a) {
            a && a instanceof P ? (this.Or = a,
                this.Ya.style.width = a.width + "px",
                this.Ya.style.height = a.height + "px") : this.Or = s
        },
        Cb: x("qe"),
        ka: x("Va"),
        DU: function () {
        ...
        TQ: function (a, b) {
            for (var c = this.va(), e = b.margins || [10, 10, 10, 10], f = b.zoomFactor || 0, g = e[1] + e[3], e = e[0] + e[2], i = c.aj(), k = c = c.Yh(); k >= i; k--) {
                var m = this.va().fc(k);
                if (a.ZE().lng / m < this.width - g && a.ZE().lat / m < this.height - e)
                    break
            }
            k += f;
            k < i && (k = i);
        ...
        gX: x("Cd"),
        ku: function () {
            for (var a = this.$.mE; a < D.Zq.length; a++)
                D.Zq[a](this);
            this.$.mE = a
        },
        AE: function (a) {
        ...
        ax: function () {
            return this.R.PV && 1.5 <= this.R.devicePixelRatio
        },
        hB: function (a, b) {
            b ? this.Bh[b] || (this.Bh[b] = {}) : b = "custom";
            a.tag = b;
            a instanceof kb && (this.Bh[b][a.ea] = a,
                a.xa(this));
            var c = this;
            ...
            window.cb = function (a) {
                if (0 === a.status) {
                    3 === a.data.style.length ? (window.bmap_baseFs || (window.bmap_baseFs = a.data.style),
                        window.Np = a.data.style[2]) : window.Np = a.data.style;
        ...
        QW: function (a, b) {
            ...
            b.styleJson ? f += "styles=" + encodeURIComponent(this.RE(b.styleJson, parseInt(a, 10))) : b.styleId && (f += "styles=" + encodeURIComponent(c.RE(c.h_, parseInt(a, 10))));
            pa(f)
        },
        zE: function (a, b) {
        ...
        kL: function (a) {
            a ? this.Mr && this.Mr.yf === a || (this.Wf(this.Mr),
                this.Mr = new pb({
                    geotableId: a
                }),
                this.Ne(this.Mr)) : this.Wf(this.Mr)
        },
        Od: function () {
        ...
        Tx: function (a) {
            this.R.bE = a;
            this.ke.Jb || (this.ke.Jb = this.ke.nj[0].Jb);
            a ? (this.ke.Bf.style.display = "none",
                this.ke.Jb.parentElement.style.display = "block") : (this.ke.Bf.style.display = "block",
                    this.ke.Jb.parentElement.style.display = "none")
        },
        ...
        RE: function (a, b) {
            ...
            for (var g = 0, i; i = a[g]; g++)
                if (!this.WX(i) && (window.rh = this.pX(i, window.rh),
                    this.XX(i, b))) {
            ...
            !window.La[b].cZ && window.La[b].bmapRailwayVisibility && delete window.La[b].bmapRailwayVisibility;
            !window.La[b].mZ && window.La[b].bmapRoadarrowVisibility && delete window.La[b].bmapRoadarrowVisibility;
            return f.join(",")
        },
        i_: function (a) {
            for (var b = {
        ...
        VN: function (a, b) {
            window.Xt[b] = a;
            if (!window.rh[b])
                for (var c = this.xb.aj(), e = this.xb.Yh(); c <= e; c++)
                    window.rh[c] || (window.Xt[c] = a)
        },
        eF: function (a) {
            if (!window.rh[a])
                for (var b = this.xb.aj(), c = this.xb.Yh(); b <= c; b++)
                    window.rh[b] || (window.La[b] || (window.La[b] = {}),
    ...
    function xb(a) {
        var b = eb();
        b >= a.jz ? ($a(a.m.za) && a.m.za(a.m.ac(1)),
            $a(a.m.finish) && a.m.finish(),
            0 < a.Zf.length && (b = a.Zf[0],
                b.Zf = [].concat(a.Zf.slice(1)),
                b.start())) : (a.Qx = a.m.ac((b - a.mu) / a.m.duration),
                    $a(a.m.za) && a.m.za(a.Qx),
                    a.TE || (a.sr = setTimeout(function () {
                        xb(a)
                    }, 1E3 / a.m.Hc)))
    }
    ...
    var H = {
        ...
        pF: new P(13, 1),
        sa: D.oa + "images/",
        s3: "http://api0.map.bdimg.com/images/",
    ...
    var Q = z.lang.cu;
    function I() {
        return !(!z.platform.DD && !z.platform.VX && !z.platform.jj)
    }
    function Xa() {
        return !(!z.platform.xL && !z.platform.pL && !z.platform.cY)
    }
    function eb() {
    ...
    void function (a, b, c) {
        void function (a, b, c) {
            function i(a) {
                if (!a.qo) {
                    for (var c = p, e = [], g = a.iZ, k = 0; g && k < g.length; k++) {
                        var m = g[k]
                            , n = da[m] = da[m] || {};
                        if (n.qo || n == a)
                            e.push(n.Mc);
            ...
            if (!B || !B.qo) {
                ...
                y.prototype.start = y.prototype.create = function (a) {
                    if (!this.DJ) {
                        ...
                        this.DJ = new Date;
                        for (this.es("create", this); a = this.cJ.shift();)
                            v.apply(this, a)
                    }
                }
                    ;
        ...
        void function (a, b, c) {
            ...
            if (v && v.mh && m() < v.mh) {
                var C = ["Moz", "O", "ms", "Webkit"]
                    ...
                    , Ni = function () {
                        return !!b.createElementNS && !!b.createElementNS("http://www.w3.org/2000/svg", "svg").P1
                    }
                    , Oi = function () {
                        return !!a.D0
                    }
                    , Pi = function () {
                        return "WebSocket" in a && a.A0.o0 === 2
                    }
                    , Qi = function () {
                    ...
                    , Vi = function () {
                        return !!a.webkitNotifications || "Notification" in a && "permission" in a.HO && "requestPermission" in a.HO
                    }
                    , Wi = function () {
    ...
    ; var Tb = {
        ...
        style: "xuda1u",
        tile: "so0om1",
        groundoverlay: "jpbzhp",
        pointcollection: "pec3gw",
        marker: "odeouz",
        symbol: "w5tsjt",
        canvablepath: "n0lutl",
        vmlcontext: "2ikthc",
        markeranimation: "zkubom",
        poly: "zodmth",
        draw: "rrp4de",
        drawbysvg: "fblmbk",
        drawbyvml: "5s0wpj",
        ...
        navictrl: "1u4l05",
        geoctrl: "y10hst",
        copyrightctrl: "42mo2j",
        citylistcontrol: "dxjt3f",
        scommon: "byntbu",
        local: "0jxgrm",
        route: "d4wzko",
        othersearch: "ili554",
        mapclick: "0mtvbw",
        buslinesearch: "wwvhvi",
        hotspot: "l14bz0",
        autocomplete: "4usfdn",
        coordtrans: "1l21mt",
        coordtransutils: "3ou01l",
        convertor: "5kcjgx",
        clayer: "suh2fo",
        pservice: "n500r3",
        pcommon: "xw3let",
        panorama: "0icifm",
        panoramaflash: "tpyaye"
    };
    z.dy = function () {
        function a(a) {
    ...
    z.object.extend(K, {
        ...
        tJ: function (a) {
            if (a && this.vK()[a])
                for (var a = this.vK()[a], b = 0; b < a.length; b++)
                    this.tJ(a[b]),
        ...
        nZ: function (a, b) {
            ...
            c.Le = this.uj.Ep;
            for (var f = 0, g = c.ru.length; f < g; f++)
                c.ru[f]();
            c.ru.length = 0
        },
        oJ: function (a, b) {
        ...
        AU: function (a, b) {
            for (var c = this.Qd.uv, e = p, f = 0, g = c.length; f < g; f++)
                "" == c[f].ZD && (c[f].aM == a ? c[f].ZD = b : e = t);
            e && this.cK()
        },
        cK: function () {
            for (var a = this.Qd.uv, b = 0, c = a.length; b < c; b++)
                this.nZ(a[b].aM, a[b].ZD);
            this.Qd.uv.length = 0
        }
    });
    function R(a, b) {
    ...
    function kb(a, b) {
        a && (this.Mb = a,
            ...
            b = b || {},
            this.Sg = b.text || "",
            this.$u = b.offsets ? b.offsets.slice(0) : [5, 5, 5, 5],
            this.aB = b.userData || s,
            this.Dh = b.minZoom || s,
            this.Ef = b.maxZoom || s)
    }
    kb.ea = 0;
    ...
    z.extend(Ub.prototype, {
        ...
        uc: function (a) {
            if (this.v1 || !Za(a) || isNaN(a) || a < Wb || 3 < a)
    ...
    function Zb(a) {
        ...
        this.m = {
            ...
            YZ: a.showAddressBar !== t,
            d2: a.enableAutoLocation || t,
            TL: a.locationIcon || s
        };
        var b = this;
        this.ou = 1200;
    ...
    function ob(a) {
        ...
        this.m = {
            zg: t,
            fh: [Pa, ab, Va, Sa],
            iV: ["B_DIMENSIONAL_MAP", "B_SATELLITE_MAP", "B_NORMAL_MAP"],
            type: a.type || bc,
            Da: a.offset || this.defaultOffset,
            SV: p
        };
    ...
    z.object.extend(fc.prototype, {
        ...
        pE: function (a) {
            if (this.Ee[a]) {
                for (var b = 0, c = this.Aa.length; b < c; b++)
                    this.Aa[b] && ("divider" == this.Aa[b].Nb && this.Aa[b].Bj == a) && (this.Aa.splice(b, 1),
                        c--),
    ...
    function hb(a, b) {
        a && !b && (b = a);
        this.He = this.Wd = this.Me = this.Yd = this.Dl = this.ol = s;
        a && (this.Dl = new J(a.lng, a.lat),
            this.ol = new J(b.lng, b.lat),
            this.Me = a.lng,
            this.Yd = a.lat,
            this.He = b.lng,
            this.Wd = b.lat)
    ...
    z.object.extend(hb.prototype, {
        ...
        oc: function (a) {
            return !(a instanceof hb) || this.lj() ? t : this.Te().oc(a.Te()) && this.Of().oc(a.Of())
        },
        Te: x("Dl"),
        Of: x("ol"),
        PU: function (a) {
            return !(a instanceof hb) || this.lj() || a.lj() ? t : a.Me > this.Me && a.He < this.He && a.Yd > this.Yd && a.Wd < this.Wd
        },
        Cb: function () {
            return this.lj() ? s : new J((this.Me + this.He) / 2, (this.Yd + this.Wd) / 2)
        },
        Hs: function (a) {
        ...
        Er: function (a) {
            return !(a instanceof J) || this.lj() ? t : a.lng >= this.Me && a.lng <= this.He && a.lat >= this.Yd && a.lat <= this.Wd
        },
        extend: function (a) {
            if (a instanceof J) {
                var b = a.lng
                ...
                if (!this.Me || this.Me > b)
                    this.Dl.lng = this.Me = b;
                if (!this.He || this.He < b)
                    this.ol.lng = this.He = b;
                if (!this.Yd || this.Yd > a)
                    this.Dl.lat = this.Yd = a;
                if (!this.Wd || this.Wd < a)
                    this.ol.lat = this.Wd = a
            }
        },
        ZE: function () {
            return this.lj() ? new J(0, 0) : new J(Math.abs(this.He - this.Me), Math.abs(this.Wd - this.Yd))
        }
    });
    function J(a, b) {
        isNaN(a) && (a = Lb(a),
    ...
    z.extend(S, {
        ...
        kf: function (a, b, c, e) {
            return this.yO * Math.acos(Math.sin(c) * Math.sin(e) + Math.cos(c) * Math.cos(e) * Math.cos(b - a))
        },
        Lk: function (a) {
    ...
    z.extend(jb.prototype, {
        ci: function (a, b) {
            return this.MP(b, S.Gb(a))
        },
        gh: function (a, b) {
            return S.dc(this.NP(b, a))
        },
    ...
    nc.prototype.draw = function (a) {
        if (D.Hp) {
            ...
            "canvas" === b.Nb && b.canvas && b.HP(b.canvas.getContext("2d"))
        }
        for (var c in this.Ba)
            this.Ba[c].draw(a);
        z.lc.Ob(this.De, function (a) {
            a.draw()
        });
    ...
    function oc(a) {
        ...
        if (0 > this.K.td || 1 < this.K.td)
            this.K.td = 0.65;
        if (0 > this.K.pg || 1 < this.K.pg)
            this.K.pg = 0.65;
    ...
    z.extend(pc.prototype, {
        vj: function () {
            ...
            "none" != a.borderColor && c.push("border:" + a.nx + "px " + a.hY + " " + a.JL + ";");
            c.push("opacity:" + a.opacity + "; filter:(opacity=" + 100 * a.opacity + ")");
            c.push("background:" + a.background + ";");
            c.push('z-index:60;">');
            c.push(b);
            c.push("</div>");
            this.ba = Bb(this.map.Pf().UD, c.join(""))
        },
        initialize: function (a) {
            this.map = a;
            this.vj();
    ...
    function sc(a, b, c, e) {
        a && (this.fv = {},
            this.gK = e ? !!e : t,
            this.Uc = [],
            this.m_ = a instanceof rc ? a : s,
            this.QH = b === l ? p : !!(b.indexOf("%") + 1),
            this.Oj = isNaN(parseFloat(b)) ? 1 : this.QH ? parseFloat(b) / 100 : parseFloat(b),
            this.RH = !!(c.indexOf("%") + 1),
            this.repeat = c != l ? this.RH ? parseFloat(c) / 100 : parseFloat(c) : 0)
    }
    ; function tc(a, b) {
        z.lang.Ga.call(this);
        this.content = a;
    ...
    ib.prototype.Xc = function () {
        this.map && this.map.$.fl && (this.map.$.fl.Sa = t,
            z.lang.uw(this.map.$.fl.ea),
            this.map.$.fl = s)
    }
        ;
    function uc(a, b) {
    ...
    function Ec(a) {
        var b = (window.devicePixelRatio || 1) / (a.dU || a.w5 || a.U3 || a.V3 || a.Z3 || a.dU || 1)
            , c = a.canvas.width
            , e = a.canvas.height;
        a.canvas.width = c * b;
        a.canvas.height = e * b;
    ...
    z.extend(Fc.prototype, {
        ...
        Im: function (a, b) {
            this.Tn[a] && (this.Tn[a] = new J(b.lng, b.lat),
                this.na[a] = new J(b.lng, b.lat),
    ...
    function Jc(a) {
        ...
        a.platform.appendChild(this.Bf);
    ...
    z.extend(Jc.prototype, {
        ...
        yD: function (a) {
            this.St = new Kc(this);
            this.St.Ne(new Lc(this.map, this.St, a.Ue))
        },
        ex: function () {
        ...
        wf: function () {
            this.vk--;
            var a = this;
            this.CD && (this.map.dispatchEvent(new Q("onfirsttileloaded")),
                this.CD = t);
            0 == this.vk && (this.Ci && (clearTimeout(this.Ci),
                this.Ci = s),
        ...
        QK: function (a, b, c) {
            ...
            for (this.Ce ? this.Ce.length = 0 : this.Ce = []; n < q; n++)
                for (var y = o; y < v; y++) {
                    var A = n
                        , B = y;
                    this.Ce.push([A, B]);
            ...
            for (e = this.Ce.length; n < e; n++)
                C = this.Ce[n][0],
                    ...
                    o ? (q = o.style,
                        q.left = v + "px",
                        q.top = w + "px",
                        o.mn || this.WE.push([C, k, o])) : (0 < this.Pe.length ? (o = this.Pe.shift(),
                            ...
                            q = o.style) : (o = document.createElement("canvas"),
                                ...
                                q.width = f + c + "px",
                                q.height = f + c + "px",
                                this.aY() && (q.WebkitTransform = "scale(1.001)"),
        ...
        a_: function (a, b, c, e) {
            ...
            m && m.Kb ? (yb(m.Kb, b),
                e && (e = new R(a[0], a[1]),
                    g = this.map.R.xe ? this.map.R.xe.style : "normal",
                    e = c.getTilesUrl(e, a[2], g),
                    m.loaded = t,
                    Pc(m, e)),
                m.loaded ? this.wf() : Qc(m, function () {
                    f.wf()
                })) : (m = this.Ti[i]) && m.Kb ? (c.Jb.insertBefore(m.Kb, c.Jb.lastChild),
                    this.vg[i] = m,
                    yb(m.Kb, b),
                    e && (e = new R(a[0], a[1]),
                        g = this.map.R.xe ? this.map.R.xe.style : "normal",
        ...
        Uf: function (a) {
            if (!this.map.R.og) {
                ...
                if (b.map.va() == Sa)
                    K.load("coordtrans", function () {
                        b.map.Wb || (b.map.Wb = Sa.kk(b.map.Wg),
                            b.map.cw = Sa.sK(b.map.Wb));
                        b.xH()
                    }, p);
                else {
                    if (a && a)
        ...
        xH: function (a) {
            var b = this.nj.concat(this.Xf)
                ...
                , i = e.width
                , i = e.va().fc(e.Va) * i
                , i = this.QX(g.lng - i / 2, g.lng + i / 2);
            this.map.va() !== ab && this.map.va() !== Va && (g = this.uU(g));
            for (var k = 0; k < c; k++) {
                var m = b[k];
                if (m.hc && e.Va < m.hc)
                    break;
                ...
                if (!m.a1 && !(m.jx && !this.map.Od() || m.vL && this.map.Od())) {
                    e = this.map;
                    f = e.va();
                    n = f.pk();
                    q = e.Va;
                    g = e.gc;
                    f == Sa && g.oc(new J(0, 0)) && (g = e.gc = n.ci(e.qe, e.Wb));
                    var w = f.fc(q)
                        , n = f.VK(q)
                        , o = Math.ceil(g.lng / n)
                        , y = Math.ceil(g.lat / n)
                    ...
                    var C = this.vg, A = -this.aJ.lng / w, B = this.aJ.lat / w, g = [Math.ceil(A), Math.ceil(B)], w = e.ka(), F;
                    for (F in C) {
                        var E = C[F]
                            , G = E.info;
                    ...
                    this.map.va() !== ab && this.map.va() !== Va && (A = this.vU(A, q));
                    A.sort(function (a) {
                        return function (b, c) {
                            return 0.4 * Math.abs(b[0] - a[0]) + 0.6 * Math.abs(b[1] - a[1]) - (0.4 * Math.abs(c[0] - a[0]) + 0.6 * Math.abs(c[1] - a[1]))
                        }
        ...
        Ag: function () {
            for (var a = this.nj, b = 0, c = a.length; b < c; b++)
                a[b].remove();
            delete this.Jb;
            this.nj = [];
            this.Ti = this.vg = {};
        ...
        ot: function (a) {
            var b = this.map.va();
            if (!this.map.Od() && (a ? this.map.R.j_ = a : a = this.map.R.j_,
                a))
                for (var c = s, c = "2" == D.Rt ? [D.url.proto + D.url.domain.main_domain_cdn.other[0] + "/"] : [D.url.proto + D.url.domain.main_domain_cdn.baidu[0] + "/", D.url.proto + D.url.domain.main_domain_cdn.baidu[1] + "/", D.url.proto + D.url.domain.main_domain_cdn.baidu[2] + "/"], e = 0, f; f = this.nj[e]; e++)
                    if (f.WZ == p) {
                        b.m.pc = 18;
                        f.getTilesUrl = function (b, e) {
                            var f = b.x
                                , f = this.map.ke.Xv(f, e).Sl
                                , m = b.y
                                , n = Sb("normal")
                                , o = 1;
                            this.map.ax() && (o = 2);
    ...
    function Rc(a, b, c, e, f) {
        ...
        this.Kb.onload = function () {
            ...
            if (i.rm) {
                ...
                if (i.Kb && !Ab(i.Kb) && f.Jb) {
                    f.Jb.appendChild(i.Kb);
                    if (z.fa.ma <= 6 && z.fa.ma > 0 && i.BI)
                        i.Kb.style.cssText = i.Kb.style.cssText + (';filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src="' + i.src + '",sizingMethod=scale);')
                }
                var c = a.lE - a.sU, e;
                for (e in b) {
                    if (c <= 0)
                ...
                Tc && new ub({
                    ...
                    za: function (a) {
                        if (i.Kb && i.Kb.style)
                            i.Kb.style.opacity = a * 1
                    },
                    finish: function () {
                        i.Kb && i.Kb.style && delete i.Kb.style.opacity
                    }
                });
                Nc(i)
            }
        ...
        this.Kb.onerror = function () {
            ...
            if (i.rm) {
                ...
                if (a.m.zC) {
                    i.error = p;
                    i.Kb.src = a.m.zC;
                    i.Kb && !Ab(i.Kb) && f.Jb.appendChild(i.Kb)
                }
            }
        }
            ;
    ...
    Rc.prototype.Cn = function () {
        this.Kb.src = 0 < z.fa.ma && 6 >= z.fa.ma && this.BI ? H.sa + "blank.gif" : "" !== this.src && this.Kb.src == this.src ? this.src + "&t = " + Date.now() : this.src
    }
        ;
    function Nc(a) {
    ...
    function Mc(a) {
        this.Ue = a || {};
        this.SU = this.Ue.copyright || s;
        this.K_ = this.Ue.transparentPng || t;
        this.Wv = this.Ue.baseLayer || t;
    ...
    function Uc(a) {
        ...
        this.zT = D.url.proto + D.url.domain.traffic + "/traffic/"
    }
    Uc.prototype = new Mc;
    ...
    Uc.prototype.getTilesUrl = function (a, b) {
        ...
        this.m.predictDate ? c = "HistoryService?day=" + (this.m.predictDate.weekday - 1) + "&hour=" + this.m.predictDate.hour + "&t=" + (new Date).getTime() + "&" : (c = "TrafficTileService?time=" + (new Date).getTime() + "&",
            c += "label=web2D&v=016&");
        var c = this.zT + c + "level=" + b + "&x=" + a.x + "&y=" + a.y
            , e = 1;
        this.M.ax() && (e = 2);
    ...
    pb.prototype.getTilesUrl = function (a, b) {
        var c = a.x
            , e = a.y
            , f = this.$a
            , c = Vc[Math.abs(c + e) % Vc.length] + "/image?grids=" + c + "_" + e + "_" + b + "&q=" + f.ht + "&tags=" + f.SE + "&filter=" + f.filter + "&sortby=" + f.tN + "&ak=" + this.$a.oB + "&age=" + f.YI + "&page_size=" + f.FM + "&format=" + f.u_;
        f.gF || (f = (1E5 * Math.random()).toFixed(0),
            c += "&timeStamp=" + f);
                ...
                for (var a = a[6], k = 0; k < i.length; k++) {
                    ...
                    if (n && n.length)
                        for (var o = i[k][1], q = 0; q < o.length; q++) {
                            var v = o[q][1];
                            f.Nc(v[0], c) && (v["cache" + c] || (v["cache" + c] = f.xm(v[1], c, e, a)),
                                v = v["cache" + c],
                                f.M.Yn(b.canvas.id, v, {
                                    type: "polygon",
                                    Vb: m,
                                    style: n
                                }),
        ...
        IV: function (a, b, c, e) {
            ...
            if (!c.Vb || !(6 < e && (71013 === c.Vb || 71012 === c.Vb || 71011 === c.Vb) || 6 === e && (71011 === c.Vb || 71012 === c.Vb) || 5 === e && (71011 === c.Vb || 71013 === c.Vb) || 5 > e && (71012 === c.Vb || 71013 === c.Vb))) {
                ...
                for (var e = 2, f = b.length; e < f; e += 2)
                    a.lineTo(b[e], b[e + 1]);
                a.closePath();
                c.borderWidth && (a.strokeStyle = c.io,
                ...
                for (var a = a[6], i = 0; i < g.length; i++) {
                    ...
                    if (m && m.length && m[0].borderWidth)
                        for (var n = g[i][1], o = 0; o < n.length; o++) {
                            var q = n[o][1];
                            f.Nc(q[0], c) && (q["cache" + c] || (q["cache" + c] = f.xm(q[1], c, e, a)),
                                q = q["cache" + c],
        ...
        JV: function (a, b, c, e) {
            ...
            if (!(c < e.filter)) {
                ...
                for (var c = 2, f = b.length; c < f; c += 2)
                    a.lineTo(b[c], b[c + 1]);
                a.closePath();
                e.borderWidth && (a.strokeStyle = e.io,
    ...
    var gd = {
        parse: function (a, b, c, e, f) {
            for (var g = e.M, i = g.ka(), k = Math.pow(2, 18 - i), m = g.Pc.ci(g.Cb()), n = m.lng, o = m.lat, m = g.Hb(), q = m.width, v = m.height, m = [], w = 0; w < a.length; w++) {
                ...
                for (var B = (A[0] * c * k - n) / k + q / 2, C = (o - (A[1] + 1) * c * k) / k + v / 2, F = 0; F < a[w].length; F++)
                    a[w][F].BL ? this.BM(a[w][F].BL, A, e, b, c, B, C, i, k, q, v, y) : a[w][F].CX ? this.BM(a[w][F].CX, A, e, b, c, B, C, i, k, q, v, y, p, window.t3) : this.MY(a[w][F].fY, A, e, b, c, B, C, i, k, q, v, y, f);
                m.push(y)
            }
            ...
            for (w = 0; w < a.length; w++)
                if (c = a[w],
                    ...
                    if (F = [c.Sf, c.Tf, c.Sf, c.gi, c.fi, c.gi, c.fi, c.Tf, c.Sf, c.Tf],
                        ...
                        "fixed" === c.type) {
                        F = t;
                        c.ve && (c.style && 4 === c.direction) && (F = p);
                        if (c.ve)
                            if (F) {
                                var E = this;
                                this.Yr(b, c, e, F, function (a) {
                                    for (var c = 0; c < a.sf.length; c++)
                                        E.UJ(b, a.sf[c].ae, a.sf[c].be, a.sf[c].text, a.style, e)
                                })
                            } else
                                this.Yr(b, c, e);
                        if (c.style && !F)
                            for (F = 0; F < c.sf.length; F++)
                                this.UJ(b, c.sf[F].ae, c.sf[F].be, c.sf[F].text, c.style, e)
                    } else if ("line" === c.type)
                        for (F = 0; F < c.iO.length; F++)
                            f = c.iO[F],
                                gd.EV(b, f.ae, f.be, f.XT, f.gO, f.width, f.height, c.style, e);
            return m
        },
        ...
        MY: function (a, b, c, e, f, g, i, k, m, n, o, q, v) {
            b = a[7].length;
        ...
        RJ: function (a, b, c, e, f) {
            ...
            if (b.style && 62203 === q) {
                for (var v = n = m = 0; v < b.sf.length; v++)
                    m < b.sf[v].width && (m = b.sf[v].width),
                        n += 20;
                m = Math.ceil(m) + 10
            }
            e && 519 === q && (o = t);
            m !== s && n !== s ? this.HV(a, b, c, 8, m, n) : e && o ? (m = Math.ceil(b.sf[0].width) + 6,
                this.AV(a, b, c, 12, m, c.height / 2)) : a.drawImage(c, i, k, g.width, g.height);
            f && f(b)
        },
        HV: function (a, b, c, e, f, g) {
            var i = b.zx[0] - f / 2
                , b = b.zx[1] - g / 2;
        ...
        ZY: function (a, b) {
                ...
                for (var i = a[f], k = 0, m = i.length; k < m; k++) {
                    ...
                    if ("fixed" === n.type) {
                        ...
                        for (y = 0; y < A.length; y++) {
                            ...
                            o !== l ? (B.ae < o && (o = B.ae),
                                B.be < q && (q = B.be),
                                B.ae + B.width > v && (v = B.ae + B.width),
                                B.be + B.height > w && (w = B.be + B.height)) : (o = B.ae,
                                    q = B.be,
                                    v = B.ae + B.width,
                                    w = B.be + B.height)
                        }
            ...
            c.sort(function (a, b) {
                return b.Lx - a.Lx || b.Sf - a.Sf || b.Tf - a.Tf
            });
            f = 0;
            for (g = c.length; f < g; f++) {
                ...
                for (k = f + 1; k < g; k++)
                    i = c[k],
                        m.fi - e < i.Sf || (m.Sf > i.fi - e || m.gi - e < i.Tf || m.Tf > i.gi - e) || m.dJ.push(k)
            }
            f = 0;
            for (g = c.length; f < g; f++)
                if (k = c[f],
    ...
    var md = {
        drawLink: function (a, b, c, e, f) {
            var g = a[1];
            g && (a = a[6],
                this.RN(g, c, e, b, a, f, p),
                this.RN(g, c, e, b, a, f, t))
        },
        RN: function (a, b, c, e, f, g, i) {
                ...
                if (n && n.length && (!i || n[0].borderWidth))
                    if (!n[0].zo || ld(n[0].zo, b))
                        for (var o = a[k][1], q = 0; q < o.length; q++) {
                            var v = o[q][3];
                            g.Nc(v[0], b) && (v["cache" + b] || (v["cache" + b] = g.xm(v[1], b, c, f)),
                                v = v["cache" + b],
                                g.M.Yn(e.canvas.id, v, {
                                    type: "polyline",
                                    Vb: m,
                                    style: n
                                }),
        ...
        FV: function (a, b, c, e, f) {
            c = c[0];
            if (!e && c.zo && ld(c.zo, f))
                this.MV(a, b, c, ld(c.zo, f));
            else {
                a.beginPath();
                a.moveTo(b[0], b[1]);
                for (var f = 2, g = b.length; f < g; f += 2)
                    a.lineTo(b[f], b[f + 1]);
                c.borderWidth && e ? (a.strokeStyle = c.io,
                    a.lineCap = hd[c.mU],
                    a.lineJoin = id[1],
                    a.lineWidth = c.borderWidth / 2,
                    a.stroke()) : e || (a.strokeStyle = c.Cw,
                        a.lineCap = hd[c.$V],
                        a.lineJoin = id[1],
                        a.lineWidth = c.fK / 2,
                        a.stroke())
    ...
    yd.prototype = {
        eC: function (a, b, c, e, f, g, i, k, m) {
            ...
            var n = this;
            m || (m = 0);
            if (!(z.om(window.rh) ? window.Np : window.Xt[f]) && 100 > m)
                setTimeout(function () {
                ...
                17 <= this.M.ka() ? (n.TJ(a, o, f, g, i, c, e),
                    b.mn = p) : setTimeout(function () {
                        if (!b.zG) {
                            n.TJ(a, o, f, g, i, c, e);
                            b.mn = p
                        }
        ...
        SJ: function (a, b, c, e, f, g, i) {
            ...
            !(z.om(window.rh) ? window.Np : window.Xt[g]) && 100 > i ? setTimeout(function () {
                ...
                a.TY = gd.parse(a, c, e, this, f))
        },
        hj: function (a, b, c, e) {
            var f = a + "-" + b + "-" + c;
            if (e)
                return td[f] || (td[f] = this.rg(a, b, c, e)),
                    td[f];
            this.M.xN[f] = this.rg(a, b, c);
            return this.M.xN[f]
        },
        rg: function (a, b, c, e) {
            var f;
        ...
        AW: function () {
            if (this.tD)
                return this.tD;
            var a = "undefined" !== typeof MSV ? MSV.P3 : {};
            return this.tD = {
                iF: a.version ? a.version : "001",
                dF: a.L_ ? a.L_ : "20150621"
            }
        }
    };
    Q = z.lang.cu;
    ...
    function Lc(a, b, c) {
        ...
        for (e in c)
            c.hasOwnProperty(e) && (this.$A = this.$A + "&" + e + "=" + c[e]);
        this.Xg = {};
        this.Jr = [];
        this.Ps = 0;
        this.hx = t;
                    ...
                    if (k)
                        for (var m = 0; m < k.length; m++)
                            for (var n = k[m], o = 0; o < n.length; o++)
                                if (a = n[o],
                                    !a.Js && a.Es && b > a.Sf && b < a.fi && c > a.Tf && c < a.gi) {
                                    b = a.Es;
                                    b = {
                                        type: 9,
                                        name: a.name,
    ...
    fa.Wo = function (a) {
        ...
        for (k = a.length; b < k; b++) {
            ...
            if (B)
                C = B.style,
                    ...
                    C.width = f + "px",
                    C.height = f + "px",
                    B.mn ? B.VE && B.VE && this.Jr.push(B.VE) : (B.zG = p,
                        B.dB = s,
                        delete B.dB,
                        o.push([n, q, B]));
            else {
        ...
        if (0 === o.length) {
            ...
            e = this.Cd.ks(c);
            f = {};
            for (g = 0; g < this.sw.length; g++)
                i = this.sw[g],
                    i = a + "_" + i[0] + "_" + i[1] + "_" + e + "_" + c,
                    this.Xg[i] && (f[i] = this.Xg[i],
                        this.fF && this.Fv.fC.eC(this.Xg[i].Z_, this.Xg[i].r_, this.Xg[i].Sl, this.Xg[i].Dm, this.Xg[i].TD, this.Cd.Id(this.Xg[i].TD), this.Cd.aD(this.Xg[i].TD), this.$a.sD));
            this.Xg = f
        } else {
            this.Ps = o.length;
            this.hx = t;
    ...
    function Bd(a, b, c, e, f) {
        ...
        var k = a
            , m = k.M
            , n = []
            , n = "0" === D.Rt ? k.$a.DN.http : k.$a.DN.https
                ...
                if (o !== t) {
                    ...
                    if (m.R.gk) {
                        if (k.Xg[f.id] = {
                            ...
                            k.Fv.fC.eC(a, f, b, c, n, k.Cd.Id(n), k.Cd.aD(n), k.$a.sD),
                            k.$a.JE) {
                            n = [];
                            n.s_ = [b, c, e];
                            if (a[0])
    ...
    function Ad(a) {
        if (a.lx) {
            ...
            if (b.R.gk) {
                ...
                "moving" !== a.M_ && b.dispatchEvent(new Q("ontilesloaded"))
            }
        }
    }
    fa.Ql = function () {
    ...
    fa.remove = function () {
        var a = this.M.ke;
        this.Un && a.Bf.removeChild(this.Un)
    }
        ;
    function Kc(a) {
        this.M = a.map;
    ...
    var Pa = new Dd("\u5730\u56fe", Hd, {
        ...
        , Id = new Mc;
    Id.CN = [D.url.proto + D.url.domain.TIlE_PERSPECT_URLS[0] + "/resource/mappic/", D.url.proto + D.url.domain.TIlE_PERSPECT_URLS[1] + "/resource/mappic/", D.url.proto + D.url.domain.TIlE_PERSPECT_URLS[2] + "/resource/mappic/", D.url.proto + D.url.domain.TIlE_PERSPECT_URLS[3] + "/resource/mappic/"];
    Id.getTilesUrl = function (a, b) {
        var c = a.x
            , e = a.y
            , f = 256 * Math.pow(2, 20 - b)
            , e = Math.round((9998336 - f * e) / f) - 1;
        return url = this.CN[Math.abs(c + e) % this.CN.length] + this.map.Wb + "/" + this.map.cw + "/3/lv" + (21 - b) + "/" + c + "," + e + ".jpg"
    }
        ;
    var Sa = new Dd("\u4e09\u7ef4", Id, {
        tips: "\u663e\u793a\u4e09\u7ef4\u5730\u56fe",
    ...
    z.extend(be.prototype, {
        ...
        aV: function () {
            ...
            this.page > this.Jd - this.Vf && this.page >= this.Vf && (e = this.Jd - this.Vf + 1,
                b = this.Jd);
            for (f = e; f <= b; f++)
    ...
    function ee(a, b) {
        ...
        b = b || {};
        this.wt(b.policy);
        this.hN(b.intercityPolicy);
        this.pN(b.transitTypePolicy);
        this.np(b.pageCapacity);
        this.Eb = Ud;
        this.Mp = Ld;
        this.Ba = [];
    ...
    ee.Xm = 100;
    ee.zO = [0, 1, 0, 0, 0, 0, 0, 0, 2, 0, 0, 0, 1, 1, 1];
    ee.AO = [0, 3, 4, 0, 0, 0, 5];
    ...
    ge.OO = " \u73af\u5c9b \u65e0\u5c5e\u6027\u9053\u8def \u4e3b\u8def \u9ad8\u901f\u8fde\u63a5\u8def \u4ea4\u53c9\u70b9\u5185\u8def\u6bb5 \u8fde\u63a5\u9053\u8def \u505c\u8f66\u573a\u5185\u90e8\u9053\u8def \u670d\u52a1\u533a\u5185\u90e8\u9053\u8def \u6865 \u6b65\u884c\u8857 \u8f85\u8def \u531d\u9053 \u5168\u5c01\u95ed\u9053\u8def \u672a\u5b9a\u4e49\u4ea4\u901a\u533a\u57df POI\u8fde\u63a5\u8def \u96a7\u9053 \u6b65\u884c\u9053 \u516c\u4ea4\u4e13\u7528\u9053 \u63d0\u524d\u53f3\u8f6c\u9053".split(" ");
    z.wa(ge, de, "DWRoute");
    ...
    we.ER = H.sa + "iw_minus.gif";
    we.vT = H.sa + "stop_icon.png";
    z.wa(we, X);
    ...
    function Ra(a, b) {
        function c() {
            f.m.visible ? ("inter" === f.Je && f.m.haveBreakId && f.m.indoorExitControl === p ? z.U.show(f.Lz) : z.U.aa(f.Lz),
                this.m.closeControl && this.xf && this.M && this.M.Ta() === this.P ? z.U.show(f.xf) : z.U.aa(f.xf),
                this.m.forceCloseControl && z.U.show(f.xf)) : (z.U.aa(f.xf),
                    z.U.aa(f.Lz))
        }
        ...
        this.Ba = [];
        this.Kc = 1;
        this.Je = this.cS = this.Yk = "";
        this.Ie = {};
        this.Kf = s;
        this.Og = [];
        this.Rq = [];
        "cvsRender" == this.Sj || Qa() ? (this.Kj = 90,
        ...
        this.Cn = function () {
            ...
            ;
        this.m.PR !== p && (this.Cn(),
            D.Tp("cus.fire", "count", "z_loadpanoramacount"));
        this.GS(this.P);
    ...
    z.extend(Ra.prototype, {
        ...
        Cc: function (a, b, c) {
            "object" === typeof b && (c = b,
                b = l);
            a != this.bb && (this.il = this.bb,
                this.jl = this.Mb,
                this.bb = a,
                this.Je = b || "street",
                this.Mb = s,
                c && c.pov && this.qd(c.pov))
        },
        ua: function (a) {
            a.oc(this.Mb) || (this.il = this.bb,
                this.jl = this.Mb,
                this.Mb = a,
                this.bb = s)
        },
        ...
        Qc: function (a) {
            a != this.Kc && (a > ze && (a = ze),
                a < Ae && (a = Ae),
                a != this.Kc && (this.Kc = a),
                "cssRender" === this.Sj && this.qd(this.Ha))
        },
        NA: function () {
            if (this.M)
                for (var a = this.M.Pw(), b = 0; b < a.length; b++)
    ...
    U(Be, {
        ...
        hideMapLogo: Be.Yw,
        showMapLogo: Be.KE,
        enableDoubleClickZoom: Be.f2,
        disableDoubleClickZoom: Be.W1,
        enableScrollWheelZoom: Be.RV,
        disableScrollWheelZoom: Be.sV,
        show: Be.show,
        hide: Be.aa,
        addPlugin: Be.jB,
        removePlugin: Be.oE,
            ...
            function a(a) {
                if (a) {
                    if (a.id != b.zv) {
                        ...
                        a.Ol && b.m.closeControl ? z.U.show(b.BQ) : z.U.aa(b.BQ)
                    }
                } else
                    b.bb = b.il,
                        b.Mb = b.jl,
        ...
        lL: function (a, b, c, e) {
            if (!b || !c || !c.lngLat || !c.panoInstance)
                ...
                this.Hn.wB(b, function (b) {
                    b ? f.Hn.dj(c.lngLat, Oe.CO, function (b) {
                        if (b && b.id) {
                            var g = b.id
                                , m = b.ih
                                , b = b.jh
                            ...
                            a.content = f.hR(a.content, m, c.titleTip, c.beforeDomId);
    ...
    var Xe = Se ? "-" + Se.toLowerCase() + "-" : ""
        ...
        , sf = window.cancelRequestAnimationFrame || window.x5 || window.webkitCancelRequestAnimationFrame || window.mozCancelRequestAnimationFrame || window.oCancelRequestAnimationFrame || window.msCancelRequestAnimationFrame || clearTimeout
        , tf = gf ? " translateZ(0)" : "";
    function uf(a, b) {
        var c = this, e;
        ...
        c.ga(lf, window);
        c.ga(mf);
        !hf && "none" != c.options.hO && (c.ga("DOMMouseScroll"),
            c.ga("mousewheel"));
        c.options.aw && (c.BU = setInterval(function () {
            c.AP()
        }, 500));
    ...
    uf.prototype = {
        ...
        jv: function (a) {
            ...
            this[a + "Scrollbar"] ? (this[a + "ScrollbarWrapper"] || (b = Pe.createElement("div"),
                this.options.tE ? b.className = this.options.tE + a.toUpperCase() : b.style.cssText = "position:absolute;z-index:100;" + ("h" == a ? "height:7px;bottom:1px;left:2px;right:" + (this.ri ? "7" : "2") + "px" : "width:7px;bottom:" + (this.$h ? "7" : "2") + "px;top:2px;right:1px"),
                b.style.cssText += ";pointer-events:none;" + Xe + "transition-property:opacity;" + Xe + "transition-duration:" + (this.options.ZV ? "350ms" : "0") + ";overflow:hidden;opacity:" + (this.options.Zw ? "0" : "1"),
                this.Sm.appendChild(b),
                this[a + "ScrollbarWrapper"] = b,
                b = Pe.createElement("div"),
                this.options.tE || (b.style.cssText = "position:absolute;z-index:100;background:rgba(0,0,0,0.5);border:1px solid rgba(255,255,255,0.9);" + Xe + "background-clip:padding-box;" + Xe + "box-sizing:border-box;" + ("h" == a ? "height:100%" : "width:100%") + ";" + Xe + "border-radius:3px;border-radius:3px"),
                ...
                "h" == a ? (this.YK = this.ZK.clientWidth,
                    this.sX = Qe.max(Qe.round(this.YK * this.YK / this.Rx), 8),
                    this.rX.style.width = this.sX + "px") : (this.$N = this.aO.clientHeight,
                        this.U_ = Qe.max(Qe.round(this.$N * this.$N / this.jp), 8),
                        this.T_.style.height = this.U_ + "px"),
                this.HA(a, p)) : this[a + "ScrollbarWrapper"] && (jf && (this[a + "ScrollbarIndicator"].style[Ze] = ""),
        ...
        Uq: function (a, b) {
            this.Pk || (a = this.Oo ? a : 0,
                b = this.Pm ? b : 0,
                this.options.Mk ? this.Pb.style[Ze] = "translate(" + a + "px," + b + "px) scale(" + this.scale + ")" + tf : (a = Qe.round(a),
                    b = Qe.round(b),
        ...
        HA: function (a, b) {
            ...
            this[a + "Scrollbar"] && (c *= this[a + "ScrollbarProp"],
                0 > c ? (this.options.EC || (c = this[a + "ScrollbarIndicatorSize"] + Qe.round(3 * c),
                    8 > c && (c = 8),
                    this[a + "ScrollbarIndicator"].style["h" == a ? "width" : "height"] = c + "px"),
                    c = 0) : c > this[a + "ScrollbarMaxScroll"] && (this.options.EC ? c = this[a + "ScrollbarMaxScroll"] : (c = this[a + "ScrollbarIndicatorSize"] - Qe.round(3 * (c - this[a + "ScrollbarMaxScroll"])),
                        8 > c && (c = 8),
                        this[a + "ScrollbarIndicator"].style["h" == a ? "width" : "height"] = c + "px",
                        c = this[a + "ScrollbarMaxScroll"] + (this[a + "ScrollbarIndicatorSize"] - c))),
                this[a + "ScrollbarWrapper"].style[df] = "0",
                this[a + "ScrollbarWrapper"].style.opacity = b && this.options.Zw ? "0" : "1",
                this[a + "ScrollbarIndicator"].style[Ze] = "translate(" + ("h" == a ? c + "px,0)" : "0," + c + "px)") + tf)
        },
        KP: function (a) {
            if (a.CQ === p)
                return this.fB = a.target,
                    this.Bw = Date.now(),
                    p;
            if (this.fB && this.Bw) {
                if (600 < Date.now() - this.Bw)
                    return this.Bw = this.fB = s,
                        p
            } else {
            ...
            if ("select" != b && "input" != b && "textarea" != b)
                return a.stopImmediatePropagation ? a.stopImmediatePropagation() : a.aZ = p,
                    a.stopPropagation(),
                    a.preventDefault(),
                    this.Bw = this.fB = s,
                    t
        ...
        sv: function (a) {
            ...
            if (this.enabled) {
                ...
                this.options.zoom && (hf && 1 < a.touches.length) && (e = Qe.abs(a.touches[0].pageX - a.touches[1].pageX),
                    ...
                    this.B_ = Qe.sqrt(e * e + c * c),
                    this.Ax = Qe.abs(a.touches[0].pageX + a.touches[1].pageX - 2 * this.lF) / 2 - this.x,
                    this.Bx = Qe.abs(a.touches[0].pageY + a.touches[1].pageY - 2 * this.mF) / 2 - this.y,
                ...
                if (this.options.sx && (this.options.Mk ? (c = getComputedStyle(this.Pb, s)[Ze].replace(/[^0-9\-.,]/g, "").split(","),
                    e = +(c[12] || c[4]),
                    c = +(c[13] || c[5])) : (e = +getComputedStyle(this.Pb, s).left.replace(/[^0-9-]/g, ""),
                        c = +getComputedStyle(this.Pb, s).top.replace(/[^0-9-]/g, "")),
                    e != this.x || c != this.y))
        ...
        eS: function (a) {
            ...
            if (this.options.zoom && hf && 1 < a.touches.length)
                f = Qe.abs(a.touches[0].pageX - a.touches[1].pageX),
                    ...
                    this.A_ = Qe.sqrt(f * f + g * g),
                    this.Pk = p,
                    b = 1 / this.B_ * this.A_ * this.scale,
                ...
                this.jh = b.pageY;
                if (0 < f || f < this.ge)
                    f = this.options.jo ? this.x + c / 2 : 0 <= f || 0 <= this.ge ? 0 : this.ge;
                if (g > this.nf || g < this.od)
                    g = this.options.jo ? this.y + e / 2 : g >= this.nf || 0 <= this.od ? this.nf : this.od;
                this.$B += c;
                this.aC += e;
                this.Kv = Qe.abs(this.$B);
                this.Lv = Qe.abs(this.aC);
                6 > this.Kv && 6 > this.Lv || (this.options.RD && (this.Kv > this.Lv + 5 ? (g = this.y,
                    e = 0) : this.Lv > this.Kv + 5 && (f = this.x,
                        c = 0)),
                    this.hh = p,
                    this.Uq(f, g),
                    this.UB = 0 < c ? -1 : 0 > c ? 1 : 0,
                    this.VB = 0 < e ? -1 : 0 > e ? 1 : 0,
                ...
                if (b.Pk)
                    ...
                    if (b.hh) {
                        if (300 > k && b.options.sx) {
                            ...
                            e = b.x + g.Fa;
                            f = b.y + i.Fa;
                            if (0 < b.x && 0 < e || b.x < b.ge && e < b.ge)
                                g = {
                                    Fa: 0,
                                    time: 0
                                };
                            if (b.y > b.nf && f > b.nf || b.y < b.od && f < b.od)
                                i = {
                                    Fa: 0,
                                    time: 0
                                }
                        ...
                        g.Fa || i.Fa ? (c = Qe.max(Qe.max(g.time, i.time), 10),
                            b.options.Et && (g = e - b.Mv,
                                i = f - b.Nv,
                                Qe.abs(g) < b.options.by && Qe.abs(i) < b.options.by ? b.scrollTo(b.Mv, b.Nv, 200) : (g = b.qI(e, f),
                                    e = g.x,
                                    f = g.y,
                                    c = Qe.max(g.time, c))),
                            b.scrollTo(Qe.round(e), Qe.round(f), c)) : b.options.Et ? (g = e - b.Mv,
                                i = f - b.Nv,
                                Qe.abs(g) < b.options.by && Qe.abs(i) < b.options.by ? b.scrollTo(b.Mv, b.Nv, 200) : (g = b.qI(b.x, b.y),
                        ...
                        if (hf)
                            if (b.LJ && b.options.zoom)
                                clearTimeout(b.LJ),
                                    ...
                                    b.zoom(b.ih, b.jh, 1 == b.scale ? b.options.vV : 1),
        ...
        Jn: function (a) {
            ...
            if (b == this.x && c == this.y) {
                if (this.hh && (this.hh = t,
                    this.options.yx && this.options.yx.call(this)),
                    this.$h && this.options.Zw && ("webkit" == Se && (this.ZK.style[df] = "300ms"),
                        this.ZK.style.opacity = "0"),
                    this.ri && this.options.Zw)
                    "webkit" == Se && (this.aO.style[df] = "300ms"),
        ...
        IT: function (a) {
            ...
            if ("wheelDeltaX" in a)
                ...
                return;
            if ("zoom" == b.options.hO) {
                if (e = b.scale * Math.pow(2, 1 / 3 * (e ? e / Math.abs(e) : 0)),
                    e < b.options.Ok && (e = b.options.Ok),
                    e > b.options.Cp && (e = b.options.Cp),
                    e != b.scale)
                    !b.ly && b.options.ap && b.options.ap.call(b, a),
                        b.ly++ ,
        ...
        TA: function () {
            ...
            a.Ll || (a.qj.length ? (f = a.qj.shift(),
                ...
                a.Ll = p,
                a.hh = p,
                a.options.qi) ? (a.AI(f.time),
                    a.Uq(f.x, f.y),
                    a.Ll = t,
                    f.time ? a.ga(qf) : a.Jn(0)) : (i = function () {
                        var k = Date.now(), m;
                        if (k >= e + f.time) {
                            a.Uq(f.x, f.y);
                            a.Ll = t;
                            a.options.BY && a.options.BY.call(a);
                            a.TA()
                        } else {
                            k = (k - e) / f.time - 1;
                            g = Qe.sqrt(1 - k * k);
        ...
        AI: function (a) {
            a += "ms";
            this.Pb.style[af] = a;
            this.$h && (this.rX.style[af] = a);
            this.ri && (this.T_.style[af] = a)
        },
        ...
        qI: function (a, b) {
            ...
            a = this.Ve[f];
            e = (e = Qe.abs(a - this.Ve[this.MB])) ? 500 * (Qe.abs(this.x - a) / e) : 0;
            this.MB = f;
            f = this.pf.length - 1;
            for (c = 0; c < f; c++)
                if (b >= this.pf[c]) {
        ...
        refresh: function () {
            ...
            this.Pm = this.options.Pm && (!this.options.pU && !this.Oo || this.jp > this.Tm);
            ...
            if ("string" == typeof this.options.Et) {
                ...
                for (b = c.length; a < b; a++)
                    e = this.Oj(c[a]),
                        e.left += this.lF,
                        e.top += this.mF,
                        this.Ve[a] = e.left < this.ge ? this.ge : e.left * this.scale,
                        this.pf[a] = e.top < this.od ? this.od : e.top * this.scale
            } else if (this.options.Et) {
                for (this.Ve = []; e >= this.ge;)
                    this.Ve[b] = e,
                        e -= this.Vt,
                        b++;
                this.ge % this.Vt && (this.Ve[this.Ve.length] = this.ge - this.Ve[this.Ve.length - 1] + this.Ve[this.Ve.length - 1]);
                b = e = 0;
                for (this.pf = []; e >= this.od;)
                    this.pf[b] = e,
                        e -= this.Tm,
                        b++;
        ...
        zoom: function (a, b, c, e) {
            ...
            this.options.Mk && (this.Pk = p,
                ...
                this.scale = c,
                this.refresh(),
                this.x = 0 < this.x ? 0 : this.x < this.ge ? this.ge : this.x,
                this.y = this.y > this.nf ? this.nf : this.y < this.od ? this.od : this.y,
                this.Pb.style[af] = e + "ms",
                this.Pb.style[Ze] = "translate(" + this.x + "px," + this.y + "px) scale(" + c + ")" + tf,
                this.Pk = t)
        }
    };
    function Ye(a) {
    ...
    D.wm(function (a) {
        ...
        a.addEventListener("position_changed", function () {
            a.m.visible && a.m.albumsControl === p && (b ? b.Mx(a.Yb()) : (b = new vf(a.m.albumsControlOptions),
                b.xa(a)))
        });
        a.addEventListener("albums_visible_changed", function () {
            a.m.albumsControl === p ? (b ? b.Mx(a.Yb()) : (b = new vf(a.m.albumsControlOptions),
                b.xa(a)),
                b.show()) : b.aa()
        });
    ...
    z.extend(vf.prototype, {
        ...
        Mx: function (a, b) {
            if (b || !this.Qj[this.Yc] || !(this.Qj[this.Yc].panoId == a && 3 !== this.Qj[this.Yc].recoType)) {
                var c = this
                    , e = this.RG(a);
                !b && -1 !== e && this.Qj[e] && 3 !== this.Qj[e].recoType ? this.mp(e) : this.XW(function (a) {
                ...
                z.V(b, "click", function (a) {
                    if (a = (a.srcElement || a.target).getAttribute("dataindex")) {
                        ...
                        for (var e = b.getElementsByTagName("li"), f = 0, g = e.length; f < g; f++)
                            e[f].childNodes[0].getAttribute("dataindex") === a ? z.U.eb(e[f], "pano_catlogLiActive") : z.U.tc(e[f], "pano_catlogLiActive")
                    }
                });
                var a = O("div")
                    , e = O("a")
        ...
        $U: function () {
            if (this.Ei && !(0 >= this.Ei.length)) {
                ...
                this.P.appendChild(a);
                this.cs = a;
                this.Rc.eg.style.left = this.dg.width + 8 + "px";
        ...
        wl: function (a) {
            this.Qj = a;
            this.m.showCatalog && (0 < this.Ei.length ? (Xa() ? this.ZU() : this.bV(),
                this.Rc.offsetLeft = 60) : (this.cs && (this.P.removeChild(this.cs),
                    this.cs = s,
                    this.Rc.eg.style.left = "0px"),
                    this.Bi && (this.P.removeChild(this.Bi),
                        this.Bi = s),
                    this.Rc.offsetLeft = 0));
            var b = this.DW(a);
            Xa() && (this.Ei && 0 < this.Ei.length && this.m.showExit && this.lz) && (this.Rc.offsetLeft += this.dg.width + 8,
                this.cs ? this.cs.innerHTML = this.lz : this.$U());
            this.Jh.innerHTML = b;
            this.Jh.style.width = (this.dg.width + 8) * a.length + 8 + "px";
            a = this.P.offsetWidth;
            b = this.Jh.offsetWidth;
            this.Rc.js && (b += this.Rc.js());
            b < a - 2 * this.Rc.ui - this.Rc.offsetLeft ? this.P.style.width = b + this.Rc.offsetLeft + "px" : (this.P.style.width = isNaN(Number(this.m.maxWidth)) === p ? this.m.maxWidth : this.m.maxWidth + "px",
                b < this.P.offsetWidth - 2 * this.Rc.ui - this.Rc.offsetLeft && (this.P.style.width = b + this.Rc.offsetLeft + "px"));
            this.Rc.refresh();
            this.IA = this.Jh.children;
            this.Jh.appendChild(this.Uj);
            this.Uj.style.left = "-100000px";
            a = this.RG(this.W.Yb(), this.j1);
            -1 !== a && this.mp(a)
        },
        KW: function (a) {
    ...
    U(Af, {
        ...
        pixelToPoint: Af.Ib,
        pointToPixel: Af.Sb,
        setFeatureStyle: Af.P4,
        selectBaseElement: Af.I4,
        setMapStyle: Af.ot,
        enable3DBuilding: Af.uo,
        disable3DBuilding: Af.pV,
        getPanorama: Af.vs,
        initIndoorLayer: Af.KX,
        setNormalMapDisplay: Af.Tx,
        setMapStyleV2: Af.LZ,
        setBMapCopyrightOffset: Af.zE,
        getVectorContainer: Af.lX
    });
    var Bf = Dd.prototype;
    U(Bf, {
        getTileLayer: Bf.fX,
    ...
    U(Jf, {
        ...
        setImageSize: Jf.FZ,
        setInfoWindowAnchor: Jf.IZ,
        setPrintImageUrl: Jf.UZ
    });
    var Kf = tc.prototype;
    U(Kf, {
        redraw: Kf.ie,
    ...
    U(fe, {
        ...
        setIntercityPolicy: fe.hN,
        setTransitTypePolicy: fe.pN
    });
    U(window, {
